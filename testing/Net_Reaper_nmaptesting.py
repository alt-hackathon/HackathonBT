...
class NetworkScanner:
    ...
    VULNERABILITIES = [
        ...
        {
            "name": "Open SMB",
            "description": "SMB v1 has known vulnerabilities that allow hackers to infiltrate the device.",
            "severity": "Medium",
            "check": lambda ports, banners: 445 in ports or 139 in ports,
            "port": 445 or 139,
            "recommendation": "Shut down SMB on device or ensure updated to a newer version (v2 or v3)."
        }
    ]
